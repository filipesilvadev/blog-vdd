...
<nav id="sidebar-nav" class="<?php echo esc_attr( $header_layout ); ?>" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
...
<!-- .wrapper-boxed -->
<div class="wrapper-boxed header-style-<?php echo esc_attr( $header_layout ); ?><?php if ( get_theme_mod( 'penci_body_boxed_layout' ) ) : echo ' enable-boxed'; endif;?><?php if ( get_theme_mod( 'penci_enable_dark_layout' ) ) : echo ' dark-layout-enabled'; endif;?>">
...
<!-- Navigation -->
<nav id="navigation" class="header-layout-top <?php echo esc_attr( $menu_style . ' ' . $header_class ); ?><?php if( get_theme_mod( 'penci_header_enable_padding' ) ): echo ' menu-item-padding'; endif; ?><?php if( get_theme_mod( 'penci_disable_sticky_header' ) ): echo ' penci-disable-sticky-nav'; endif; /* Check for disable sticky header */ ?>" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
	<div class="container">
...
<header id="header" class="header-<?php echo esc_attr( $header_layout ); ?><?php if( ( ( ! is_home() || ! is_front_page() ) && ! get_theme_mod( 'penci_featured_slider_all_page' ) ) || ( ( is_home() || is_front_page() ) && ! get_theme_mod( 'penci_featured_slider' ) ) ): ?> has-bottom-line<?php endif;?>" itemscope="itemscope" itemtype="http://schema.org/WPHeader"><!-- #header -->
	...
	<?php if ( in_array( $header_layout, array( 'header-2', 'header-3', 'header-5', 'header-6', 'header-8', 'header-9' ) ) ) : ?>
		<!-- Navigation -->
		<nav id="navigation" class="header-layout-bottom <?php echo esc_attr( $menu_style . ' ' . $header_class ); ?><?php if( get_theme_mod( 'penci_header_enable_padding' ) ): echo ' menu-item-padding'; endif; ?><?php if( get_theme_mod( 'penci_disable_sticky_header' ) ): echo ' penci-disable-sticky-nav'; endif; /* Check for disable sticky header */ ?>" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
			<div class="container">
				<div class="button-menu-mobile <?php echo esc_attr( $header_layout ); ?>"><i class="fa fa-bars"></i></div>
				<?php if ( $header_layout == 'header-6' || $header_layout == 'header-9' ): ?>
					<div id="logo">

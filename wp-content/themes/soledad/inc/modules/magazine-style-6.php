...
<div class="mag-post-box hentry<?php if ( $m == 1 ): echo ' first-post'; if( ! has_post_thumbnail() ): echo ' full-mag-cat'; endif;  endif; ?>">
			...
			<?php if ( ( $m == 1 && ! get_theme_mod( 'penci_home_featured_cat_author' ) ) || ! get_theme_mod( 'penci_home_featured_cat_date' ) ): ?>
				<div class="grid-post-box-meta mag-meta">
					<?php if ( $m == 1 && ! get_theme_mod( 'penci_home_featured_cat_author' ) ) : ?>
						<span class="author-italic author"><?php echo penci_get_setting('penci_trans_by'); ?> <a class="url fn n" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php the_author(); ?></a></span>
					<?php endif; ?>

...
<?php if ( $feat_query->have_posts() ) : ?>
	<div class="item">
		<div class="wrapper-item wrapper-item-classess">
			...
			$thumb = 'penci-thumb';
			if( $i%7 == 1 ): $thumb = 'penci-magazine-slider'; endif;
			?>
			<div class="penci-item-mag penci-item-<?php echo ( $i%7 ); ?>">
				...
				<div class="penci-slide-overlay penci-slider6-overlay">
					...
					<?php if( ! get_theme_mod( 'penci_featured_slider_icons' ) && ( has_post_format( 'video' ) || has_post_format( 'audio' ) || has_post_format( 'link' ) || has_post_format( 'quote' ) || has_post_format( 'gallery' ) ) ): ?>
						<a href="<?php the_permalink(); ?>" class="overlay-icon-format<?php if( $i%7 == 1 ): echo ' lager-size-icon'; endif; ?>">
					...
					<div class="penci-mag-featured-content">
						<?php if( $i%7 == 1 && ! get_theme_mod( 'penci_featured_hide_categories' ) ): ?>
			...
			<?php if( ( $i%7 == 0 || $i%7 == 1 || $i%7 == 3 || $i%7 == 5 ) && $i < $num_posts ):  echo '</div></div><div class="item"><div class="wrapper-item wrapper-item-classess">';  endif;?>

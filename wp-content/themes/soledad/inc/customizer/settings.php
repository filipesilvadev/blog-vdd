...
function pencidesign_register_theme_customizer( $wp_customize ) {
	...
	$home_url = str_replace( array( 'http://', 'https://' ), '', get_bloginfo('url') );
	$copyright_text = '@'. date("Y") . ' - '. $home_url .'. All Right Reserved. Designed and Developed by <a rel="nofollow" href="http://themeforest.net/item/soledad-multiconcept-blogmagazine-wp-theme/12945398?ref=PenciDesign" target="_blank">PenciDesign</a>';
	...
	$list_block_social = array(
		...
		'facebook'    => esc_html__( 'Hide Button Facebook', 'soledad' ),
		'twitter'     => esc_html__( 'Hide Button Twitter', 'soledad' ),
		'google_plus' => esc_html__( 'Hide Button Google Plus', 'soledad' ),
		'pinterest'   => esc_html__( 'Hide Button Pinterest', 'soledad' ),
		'linkedin'    => esc_html__( 'Hide Button Linkedin', 'soledad' ),
		'tumblr'      => esc_html__( 'Hide Button Tumblr', 'soledad' ),
		'reddit'      => esc_html__( 'Hide Button Reddit', 'soledad' ),
		'stumbleupon' => esc_html__( 'Hide Button Stumbleupon', 'soledad' ),
		'whatsapp'    => esc_html__( 'Hide Button Whatsapp', 'soledad' ),
		'telegram'    => esc_html__( 'Hide Button Telegram', 'soledad' ),
		'email'       => esc_html__( 'Hide Button Email', 'soledad' ),
	);

	foreach ( $list_block_social as $social_id => $social_label ) {

		$default = '';
		if( in_array( $social_id, array( 'linkedin','tumblr','reddit','stumbleupon','whatsapp','telegram','email' ) ) ){
			$default = 1;
		}
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sidebar_posts', array(
		'label'    => 'Enable Sidebar On Single Posts',
		'section'  => 'pencidesign_new_section_general',
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'left_sidebar_posts', array(
		'label'    => 'Enable Left Sidebar On Single Posts',
		'section'  => 'pencidesign_new_section_general',
	...
	$wp_customize->add_control( new Penci_Customize_Heading_Control( $wp_customize, 'penci_general_gprd_heading', array(
		'label'    => esc_html__( 'GPRD Policy Options', 'soledad' ),
		'section'  => 'pencidesign_new_section_general',
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'penci_disable_default_fonts', array(
		'label'    =>  esc_html__( 'Remove all default google fonts - load default fonts from located hosting ( for GPRD policy )', 'soledad' ),
		'section'  => 'pencidesign_new_section_general',
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'home_adsense_below_slider', array(
		'label'       => 'Add Google Adsense Code Below Featured Slider',
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'disable_dots_penci_slider', array(
		'label'    => 'Disable Dots for Penci Slider',
		'section'  => 'pencidesign_new_section_featured',
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'exclude_featured_cat', array(
		'label'    => 'Exclude All Posts In Featured Category/Featured Tags In Latest Posts on Homepage',
		'section'  => 'pencidesign_new_section_featured',
